...
def get_args():
    ...
    parser.add_argument('--optimizer', default='radam', type=str, help='The optimizer to use')
    ...
    parser.add_argument('--temperature',  default=298,type=float, help='Assign velocity from initial temperature in K')
    ...
    parser.add_argument('--langevin_temperature',  default=298,type=float, help='Temperature in K of the thermostat')
    ...
    parser.add_argument('--max-num-neighbors', type=int, default=64, help='Maximum number of neighbors to consider in the network')
